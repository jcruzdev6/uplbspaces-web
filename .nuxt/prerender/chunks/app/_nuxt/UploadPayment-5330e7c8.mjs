...
import { useSSRContext, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, ref } from 'file:///Users/m71/Project/us/uplbspaces-web/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrRenderList, ssrInterpolate } from 'file:///Users/m71/Project/us/uplbspaces-web/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, b as useAuthStore, n as navigateTo } from '../server.mjs';
...
import { _ as _imports_0$1, a as _imports_1$1, b as __nuxt_component_0$4 } from './google-logo-0f67db4b.mjs';
import { Form, Field } from 'file:///Users/m71/Project/us/uplbspaces-web/node_modules/vee-validate/dist/vee-validate.js';
import * as Yup from 'file:///Users/m71/Project/us/uplbspaces-web/node_modules/yup/index.js';
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$b]]);
const _sfc_main$d = {
...
const __nuxt_component_2$3 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$a]]);
const _imports_0 = "" + buildAssetsURL("uplbspacesDark275.eaf3870c.png");
const _imports_1 = "" + buildAssetsURL("upSeal40.d1b21dc6.png");
const _sfc_main$c = {};
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs) {
  const _component_IconsBars = __nuxt_component_0$2;
  const _component_NuxtLink = __nuxt_component_0$3;
  const _component_IconsMagnifyingGlass = __nuxt_component_2$3;
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0)} width="165"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0,
  ...
  _push(`<div class="d-none d-lg-inline ms-1"><small>Your online reservation system for</small><img${ssrRenderAttr("src", _imports_1)} class="mx-1"><small> U.P. Los Ba\xF1os Facilities.</small></div></div><div class="d-none d-lg-flex"><input type="text" id="headSearch" class="form-control form-control-sm rounded-start rounded-end-0" style="${ssrRenderStyle({ "width": "200px" })}" placeholder="search"><button type="button" class="btn btn-sm btn-success rounded-start-0 rounded-end">`);
...
const __nuxt_component_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$a = {
  name: "FaSolidFolder"
};
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$9 = {
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$8 = {
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$7 = {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconsCaretDown = __nuxt_component_2$2;
      const _component_NuxtLink = __nuxt_component_0$3;
      const _component_IconsFolder = __nuxt_component_2$1;
      const _component_IconsImagePortrait = __nuxt_component_3$1;
      const _component_IconsSquareXMark = __nuxt_component_4$1;
      const _component_IconsCircleUser = __nuxt_component_1$1;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "container-fluid",
        id: "nav"
      }, _attrs))}><div class="container-lg d-lg-none" id="navTagline"> Your online reservation system for U.P. Los Ba\xF1os Facilities. </div><nav class="container-lg d-none d-lg-flex" id="navContent"><ul id="navMenu" class="me-auto"><li><a href="#" class="navMenuLink" data-bs-toggle="dropdown" aria-expanded="false">Spaces `);
      ...
      ssrRenderList(unref(facilityTypeStore).facility_types, (facility_type, index) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/spaces/" + facility_type.id,
          class: "dropdown-item"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(facility_type.name)}`);
            } else {
              return [
                createTextVNode(toDisplayString(facility_type.name), 1)
              ];
            }
          }),
          _: 2
      ...
      _push(`<!--]--></ul></li><!--[-->`);
      ssrRenderList(unref(pageStore).pages, (page, index) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/pages/" + page.id,
          class: "navMenuLink"
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`\xA0My Bookings`);
          } else {
            return [
              createVNode(_component_IconsFolder),
              createTextVNode("\xA0My Bookings")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`\xA0My Account`);
          } else {
            return [
              createVNode(_component_IconsImagePortrait),
              createTextVNode("\xA0My Account")
            ];
          }
        }),
        _: 1
      ...
      _push(`\xA0Sign Out</button></li></ul><a style="${ssrRenderStyle(!unref(auth).isLoggedIn ? null : { display: "none" })}" href="#" class="navMenuLink" data-bs-toggle="modal" data-bs-target="#modalSignin">Sign In `);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "container-fluid",
    id: "footer"
  }, _attrs))}><div class="container-lg" id="footerContent"><div><address> Office of the Vice Chancellor for Administration<br> University Library of the Philippines<br>Los Ba\xF1os, Laguna<br><br>`);
  _push(ssrRenderComponent(_component_IconsPhone, { class: "me-1" }, null, _parent));
  _push(`+63 2 8536 2354<br><br><a class="link link-light" href="mailto:uplbspaces@up.edu.ph"><i class="fa-solid fa-envelope me-1"></i>uplbpspaces@up.edu.ph</a></address><br><br> \xA9 2023 by University of the Philippines.<br class="d-md-none"> All rights reserved. </div></div></div>`);
}
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconsXMark = __nuxt_component_0$4;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "modal fade",
        id: "modalSignin",
        tabindex: "-1",
...
export { __nuxt_component_0$1 as _, __nuxt_component_1 as a, __nuxt_component_2 as b, __nuxt_component_3 as c, __nuxt_component_4 as d, __nuxt_component_5 as e, __nuxt_component_6 as f, __nuxt_component_1$1 as g, __nuxt_component_2$2 as h };
//# sourceMappingURL=UploadPayment-5330e7c8.mjs.map
