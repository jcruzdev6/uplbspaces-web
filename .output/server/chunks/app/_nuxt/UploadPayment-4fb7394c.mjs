...
import { useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, ref, toDisplayString, defineComponent, createElementBlock } from 'vue';
...
import { _ as __nuxt_component_2$3 } from './nuxt-link-24bdb615.mjs';
...
import { _ as _imports_0$1, a as _imports_1, b as __nuxt_component_0$3 } from './google-logo-0f67db4b.mjs';
...
const _imports_0 = "" + buildAssetsURL("upSeal40.d1b21dc6.png");
const _sfc_main$d = {};
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="d-none d-lg-inline ms-1"><small>Your online booking system for</small><img${ssrRenderAttr("src", _imports_0)} class="mx-1"><small> U.P. Los Ba\xF1os Spaces.</small></div></div><div class="d-none d-lg-flex"><input type="text" id="headSearch" class="form-control form-control-sm rounded-start rounded-end-0" style="${ssrRenderStyle({ "width": "200px" })}" placeholder="search"><button type="button" class="btn btn-sm btn-success rounded-start-0 rounded-end">`);
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`uplbpspaces@up.edu.ph</a></address><br><br> \xA9 2023 by University of the Philippines.<br class="d-md-none"> All rights reserved. </div></div></div>`);
}
...
export { __nuxt_component_0$1 as _, __nuxt_component_1$1 as a, __nuxt_component_2 as b, __nuxt_component_3 as c, __nuxt_component_4 as d, __nuxt_component_5 as e, __nuxt_component_6 as f, __nuxt_component_1$2 as g, __nuxt_component_2$1 as h };
//# sourceMappingURL=UploadPayment-4fb7394c.mjs.map
